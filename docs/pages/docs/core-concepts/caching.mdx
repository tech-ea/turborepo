...
### Alter Caching Globally

If you want _all_ tasks to depend on the certain files, you can declare this dependency in the `globalDependencies`
array.
...
Luckily, you can control `turbo`'s cache fingerprinting (also known as "hashing") behavior based on the values of environment variables.
...
### Altering Cache Globally

If you want _all_ tasks to depend on certain environment variables, you can declare this
dependency in the `globalEnv` array.
